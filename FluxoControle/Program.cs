...
/*
    ...
    var a = "1";
    let b = 1;
    (a == b) retornará true "checagem de valor"
    (a === b) retornará false "checagem de tipo"
*/
...
// Comando Switch
int number = Random.Shared.Next(1,7); // Número aleatório entre 1 e 7
...
A_label:  //Marcador para poder usar o goto para vir para cá
